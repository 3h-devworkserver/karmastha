<div class="box box-orange">
	...
	<div class="box-body">
		<div class="form-group">
			...
			{{Form::select('manage_stock',['0' => 'No', '1'=>'Yes'],null,['class'=>'form-control manageStock'])}}
		</div>
		...
		<div class="stock-block hide">
			...
			<div class="form-group">
				...
				{{Form::select('availability',['in stock' => 'In Stock', 'out of stock'=>'Out of Stock'],null,['class'=>'form-control'])}}
			</div>
		</div>
	</div>
	<!-- /.box-body -->
