<footer class="footer-wrapper">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2">
            <h4>Help</h4>
            <ul class="list-unstyled">
                <li><a href="">how you can</a></li>
                <li><a href="">frequently ask</a></li>
        ...
        <div class="col-md-2 col-sm-2">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="">Events managment</a></li>
                <li><a href="">consultant service</a></li>
        ...
        <div class="col-md-4 col-sm-4">
          <div class="row">
            <div class="col-md-6 col-sm-6">
              <h4>Mobile App</h4>
              <a href="#" class="mobile-app"><img src="{{asset('front-images/google_play.png')}}" alt=""></a>
  ...
  <div class="secondary-footer gray-bg">
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <p class="copyright">
