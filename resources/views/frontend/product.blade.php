                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    ...
                                    <div class="imgs-zoom-area">
                                        ...
                                        <img id="zoom_03" src="{{asset('front-images/product/6.jpg')}}" data-zoom-image="{{asset('front-images/product/6.jpg')}}" alt="">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div id="gallery_01" class="carousel-btn slick-arrow-3 mt-30">
                                                    <div class="p-c thumb-image">
                                                        <a href="#" data-image="{{asset('front-images/product/2.jpg')}}" data-zoom-image="{{asset('front-images/product/2.jpg')}}">
                                                            <img class="zoom_03" src="{{asset('front-images/product/2.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="p-c">
                                                        <a href="#" data-image="{{asset('front-images/product/7.jpg')}}" data-zoom-image="{{asset('front-images/product/7.jpg')}}">
                                                            <img class="zoom_03" src="{{asset('front-images/product/7.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="p-c">
                                                        <a href="#" data-image="{{asset('front-images/product/8.jpg')}}" data-zoom-image="{{asset('front-images/product/8.jpg')}}">
                                                            <img class="zoom_03" src="{{asset('front-images/product/8.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="p-c">
                                                        <a href="#" data-image="{{asset('front-images/product/9.jpg')}}" data-zoom-image="{{asset('front-images/product/9.jpg')}}">
                                                            <img class="zoom_03" src="{{asset('front-images/product/9.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="p-c">
                                                        <a href="#" data-image="{{asset('front-images/product/10.jpg')}}" data-zoom-image="{{asset('front-images/product/10.jpg')}}">
                                                            <img class="zoom_03" src="{{asset('front-images/product/10.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="p-c">
                                                        <a href="#" data-image="{{asset('front-images/product/11.jpg')}}" data-zoom-image="{{asset('front-images/product/11.jpg')}}">
                                                            <img class="zoom_03" src="{{asset('front-images/product/11.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
