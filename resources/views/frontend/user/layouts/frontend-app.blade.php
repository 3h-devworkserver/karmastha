...
<head id="www-sitename-com" data-template-set="html5-reset">
   ...
   {{--  <link href="https://fonts.googleapis.com/css?family=Arimo|Lato:300,400" rel="stylesheet"> 
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/frontend/userdash.css')}}">
...
{{ Html::script('js/frontend/jquery.menu-aim.js') }}
{{ Html::script('js/frontend/dash_user_nav.js') }}
