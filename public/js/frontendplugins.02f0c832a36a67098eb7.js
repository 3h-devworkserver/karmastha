...
/***/ "./resources/assets/js/frontend/jquery-ui.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./resources/assets/js/frontend/jquery.nivo.slider.js":
...
================================================
    ...
    1. slick jquery carousel
    2. FancyBox v2.1.5
    3. jQuery elevateZoom 
...
/***/ "./resources/assets/js/frontend/sumoselect.min.js":
/***/ (function(module, exports, __webpack_require__) {
...
!function (e) {
  "use strict";
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./node_modules/jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "undefined" != typeof exports ? module.exports = e(require("jquery")) : e(jQuery);
}(function (e) {
  "namespace sumo";
  e.fn.SumoSelect = function (t) {
    var l = e.extend({ placeholder: "Select Here", csvDispCount: 3, captionFormat: "{0} Selected", captionFormatAllSelected: "{0} all selected!", floatWidth: 400, forceCustomRendering: !1, nativeOnDevice: ["Android", "BlackBerry", "iPhone", "iPad", "iPod", "Opera Mini", "IEMobile", "Silk"], outputAsCSV: !1, csvSepChar: ",", okCancelInMulti: !1, triggerChangeCombined: !0, selectAll: !1, search: !1, searchText: "Search...", noMatch: 'No matches for "{0}"', prefix: "", locale: ["OK", "Cancel", "Select All"], up: !1, showTitle: !0 }, t),
      ...
      var t = this;!this.sumo && e(this).is("select") && (this.sumo = { E: e(t), is_multi: e(t).attr("multiple"), select: "", caption: "", placeholder: "", optDiv: "", CaptionCont: "", ul: "", is_floating: !1, is_opened: !1, mob: !1, Pstate: [], createElems: function createElems() {
          ...
          var t = this;t.is_multi && (t.selAll = e('<p class="select-all"><span><i></i></span><label>' + l.locale[2] + "</label></p>"), t.selAll.on("click", function () {
            t.selAll.toggleClass("selected"), t.toggSelAll(t.selAll.hasClass("selected")), t.selAllState();
          ...
          var t = this,
            ...
            }).not(".hidden");s.html(l.noMatch.replace(/\{0\}/g, t.ftxt.val())).toggle(!i.length), t.selAllState();
          });
          ...
          var t = this;t.E.attr("disabled") || (t.E.trigger("sumo:opening", t), t.is_opened = !0, t.select.addClass("open"), t.E.trigger("sumo:opened", t), t.ftxt ? t.ftxt.focus() : t.select.focus(), e(document).on("click.sumo", function (e) {
            if (!t.select.is(e.target) && 0 === t.select.has(e.target).length) {
              if (!t.is_opened) return;t.hideOpts(), l.okCancelInMulti && t._cnbtn();
            }
          ...
          var t = this;t.is_opened && (t.E.trigger("sumo:closing", t), t.is_opened = !1, t.select.removeClass("open").find("ul li.sel").removeClass("sel"), t.E.trigger("sumo:closed", t), e(document).off("click.sumo"), t.select.focus(), e("body").removeClass("sumoStopScroll"), l.search && (t.ftxt.val(""), t.optDiv.find("ul.options li").removeClass("hidden"), t.optDiv.find(".no-match").toggle(!1)));
        }, setOnOpen: function setOnOpen() {
          var e = this,
              t = e.optDiv.find("li.opt:not(.hidden)").eq(l.search ? 0 : e.E[0].selectedIndex);e.optDiv.find("li.sel").removeClass("sel"), t.addClass("sel"), e.showOpts();
        }, nav: function nav(e) {
          var t,
              l = this,
        ...
        }, toggSelAll: function toggSelAll(t) {
          var l = this;l.E.find('option:not(optgroup[disabled="disabled"] option)').each(function (i, s) {
            s.disabled || (s.selected = !!t, l.mob || e(s).data("li").toggleClass("selected", !!t));
          }), l.setText(), !l.mob && l.selAll && l.selAll.removeClass("partial").toggleClass("selected", !!t), l.callChange(), l.setText(), l.setPstate();
...
__webpack_require__("./resources/assets/js/frontend/jquery.nivo.slider.js");
__webpack_require__("./resources/assets/js/frontend/plugins.js");
__webpack_require__("./resources/assets/js/frontend/jquery-ui.js");
module.exports = __webpack_require__("./resources/assets/js/frontend/sumoselect.min.js");
